...
export default class index extends Component {
  ...
  check() {
    ...
    if (
      this.state.accountbank.length < 2 ||
      ...
      this.state.accountbank == "058" ||
      this.state.accountbank == "011"
    ) {
      ...
      <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
        <KeyboardAwareScrollView keyboardShouldPersistTaps="always">
          <Otp
            ...
            otp={this.state.otp}
            chargeResponseMessage={this.state.chargeResponseMessage}
            otpEdit={otp => this.setState({ otp })}
          />
          <VBVSecure
            ...
            <View style={styles.formGroup}>
              ...
              <Text
                style={{
                  color: "#EE312A",
                  fontSize: 10,
                  display: this.state.accountnumberErr,
                  fontWeight: "bold",
                  marginTop: 5
                }}
              >
            ...
            <View style={styles.formGroup}>
              ...
              <View style={styles.input}>
                <Picker
                  ...
                  onValueChange={(itemValue, itemIndex) =>
                    this.setState({ accountbank: itemValue })
                  }
                >
                  {this.state.banks}
                </Picker>
              ...
              <Text
                style={{
                  color: "#EE312A",
                  fontSize: 10,
                  display: this.state.accountbankErr,
                  fontWeight: "bold",
                  marginTop: 5
                }}
              >
